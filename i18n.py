...
TRANSLATIONS: Dict[str, Dict[str, str]] = {
    LANG_ZH: {
        ...
        "label.video": "录制视频:",
        "label.video_length": "视频长度:",
        "label.video_interval": "视频间隔:",
        ...
        "msg.about_desc": "用于管理Isaac Lab项目训练和播放的图形界面工具",
        "msg.about_author": "作者",
        "msg.about_email": "邮箱",
    ...
    LANG_EN: {
        ...
        "label.video": "Record Video:",
        "label.video_length": "Video Length:",
        "label.video_interval": "Video Interval:",
        "label.resume": "Resume:",
        ...
        "msg.about_desc": "A GUI tool for managing Isaac Lab training and play sessions",
        "msg.about_author": "Author",
        "msg.about_email": "Email",
